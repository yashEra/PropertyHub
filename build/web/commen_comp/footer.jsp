<%-- 
    Document   : footer
    Created on : Aug 7, 2023, 2:46:18 AM
    Author     : USER
--%>
            ...
            <div class="row justify-content-center">
                <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                    ...
                    <ul class="list-unstyled">
                        <li><a class="link-secondary" href="#">House</a></li>
                        <li><a class="link-secondary" href="#">Building</a></li>
                        <li><a class="link-secondary" href="#">Land</a></li>
                    </ul>
                </div>
                <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
