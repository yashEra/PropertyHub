        ...
        <div class="row">
          <div class="col-lg-4 pb-4">
            <div class="card h-100">
              <img src="./images/shutterstock_1088460305-1000x460.jpg" alt="Residential Properties" class="card-img-top h-50 ">
              <div class="card-body d-flex flex-column">
                ...
                <a href="#" class="btn btn-primary mt-3">View Properties</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 pb-4">
            <div class="card h-100">
              <img src="./images/eyJidWNrZXQiOiJjb250ZW50Lmhzd3N0YXRpYy5jb20iLCJrZXkiOiJnaWZcL2J1eS12YWNhbnQtbG90LXVwZGF0ZTIuanBnIiwiZWRpdHMiOnsicmVzaXplIjp7IndpZHRoIjo4Mjh9fX0= (1).webp" alt="Land and Lots" class="card-img-top h-50">
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">Land and Lots</h5>
          ...
          <div class="col-lg-4 pb-4">
            <div class="card h-100">
              ...
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">Industrial Properties</h5>
          ...
          <div class="col-lg-4 pb-4">
            <div class="card h-100">
              <img src="./images/Capture-d’écran-2019-07-26-à-13.14.52.webp" alt="Luxury Properties" class="card-img-top h-50">
              <div class="card-body d-flex flex-column">
                <h5 class="card-title">Luxury Properties</h5>
